            ...
            {user === "Guest" ? (
              <>
                <ThemedText style={styles.paragraph}>
                  My Fitness is a comprehensive application designed to assist
                  you in achieving your fitness goals.
                </ThemedText>
                <ThemedText style={styles.paragraph}>
                  To support your journey, this application meticulously tracks
                  a range of your statistics and activities.
                </ThemedText>
                <ThemedText style={styles.paragraph}>
                  Within My Fitness, you will find valuable tools to monitor
                  your workouts and nutrition effectively.
                </ThemedText>
                <ThemedText style={styles.paragraph}>
              ...
              <>
                <ThemedText>
                  Welcome, {user}! My Fitness is an application dedicated to
